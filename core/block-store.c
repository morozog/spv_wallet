...
static const struct block_cpt_entry_str cpt_main[] = {
   { 452715, "00000000000000000141b0f678f4d7a5e34c57f79edf945b722e1c93c152a596"}
};
...
blockstore_get_height(const struct blockstore *bs)
{
   ...
   ASSERT(bs->height == bs->best_chain->height);
   // the chain height is offset by INITIAL_HEIGHT - since we are not storing all chain
   return bs->height+INITIAL_HEIGHT;
}
